    ...
    <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
      <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
        <div className="flex shrink-0 items-center justify-center mx-auto w-24 h-24 rounded-full bg-indigo-600 mb-10 border border-indigo-500 shadow-lg shadow-indigo-500/50">
          ...
          <div className="absolute w-72 h-72 translate-z-0 bg-indigo-400 rounded-full blur-[120px] opacity-30"></div>
          <div className="absolute w-36 h-36 translate-z-0 bg-indigo-600 rounded-full blur-[80px] opacity-90"></div>
        </div>
        <DepositForm />
      </div>
    </div>
